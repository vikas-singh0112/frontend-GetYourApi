	...
	return (
		...
		>
			<div className="flex w-full items-center justify-center">
				<div className="bg-zinc-900/20 w-full border border-zinc-800 rounded-2xl p-8 md:p-12 shadow-xl ">
					<div className="max-w-3xl">
						...
						<p className="text-zinc-400 leading-relaxed mb-6">
							...
							new frontend project. Before you can even design a UI layout or
							test a responsive feature, you have to spend hours writing massive
							mock arrays or configuring local test nodes. It completely kills
